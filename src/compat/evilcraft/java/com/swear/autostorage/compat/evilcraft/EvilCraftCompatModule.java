package com.swear.autostorage.compat.evilcraft;
...
public final class EvilCraftCompatModule implements AutoStorageCompatModule {
    ...
    public void register(AutoStorageCompatContext context) {
        EvilCraftCompat.register(MACHINES, RECIPES);
