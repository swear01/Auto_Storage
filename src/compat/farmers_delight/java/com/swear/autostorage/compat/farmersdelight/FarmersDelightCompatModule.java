package com.swear.autostorage.compat.farmersdelight;
...
public final class FarmersDelightCompatModule implements AutoStorageCompatModule {
    ...
    public void register(AutoStorageCompatContext context) {
        FarmersDelightCookingPotCompat.register(MACHINES, RECIPES);
