package com.swear.autostorage.compat.create;
...
public final class CreateCompatModule implements AutoStorageCompatModule {
    ...
    public void register(AutoStorageCompatContext context) {
        CreateCompat.register(MACHINES, RECIPES);
