...
public final class RecipePresentation {
    ...
    private static final String ID_KEY = "auto_storage:recipe_presentation_id";
    private static final String KIND_KEY = "auto_storage:recipe_presentation_kind";
    private static final String STATION_ID_KEY = "auto_storage:recipe_presentation_station_id";
    private static final String WIDTH_KEY = "auto_storage:recipe_presentation_width";
    private static final String HEIGHT_KEY = "auto_storage:recipe_presentation_height";
    private static final String SHAPELESS_KEY = "auto_storage:recipe_presentation_shapeless";
    private static final String ITEM_RESOURCE_COUNT_KEY =
            "auto_storage:recipe_presentation_item_resource_count";
    private static final String TOOL_AVAILABLE_KEY =
            "auto_storage:recipe_presentation_tool_available";
    private static final String TOOL_REQUIRED_KEY =
            "auto_storage:recipe_presentation_tool_required";
    private static final String TOOL_INFINITE_KEY =
            "auto_storage:recipe_presentation_tool_infinite";
    private static final String STATION_WORK_AVAILABLE_KEY =
            "auto_storage:recipe_presentation_station_work_available";
    private static final String STATION_WORK_REQUIRED_KEY =
            "auto_storage:recipe_presentation_station_work_required";
