...
SCENARIOS = {
    ...
    "crafting-fuel-page": {
        ...
        "checks": [
            ...
            "Use Transform; confirm item-grid sorting/search/recipe controls hide, the input slot starts empty, and its cards place each representative item and amount horizontally side by side.",
            "Shift-click the preloaded Coal from hotbar `3` into Transform. Confirm the compact Transform Target bar is visually separate above the conversion cards: left-click or wheel-down cycles forward, right-click or wheel-up cycles backward, and middle-click resets to Auto without scrolling the row.",
            ...
            "Use the separate Transform Target list button; confirm the popup contains Auto plus every current target with its representative item, marks the selected row, uses bounded scrolling when needed, stays clear of the left rail/EMI overlay, and closes on selection, Escape, or a click outside the popup without leaving a focus border.",
            "Open Stations. Confirm exactly two top-aligned full-width groups—Processing Stations and Instant Stations—use the same light vanilla container panels, horizontal icon+installed-count rows, visible previous/next buttons, and panel-local wheel paging. Processing Stations includes Iron Furnace, Blast Furnace, Smoker, Campfire, Brewing Stand, Cooking Pot, and supported Mekanism machines; Instant Stations contains Crafting Table, Stonecutter, and Smithing Table without fake work totals.",
            ...
            "Confirm Stations shows no permanent rate formula or per-tile explanatory labels. Hover details appear only over the actual station slot or horizontal amount, and report the exact installed variant and combined decimal rate per tick.",
            ...
            "Cycle the resource selector through preloaded Fluids, Energy, Gases, and Other; confirm water/lava, NeoForge power, Mekanism oxygen/hydrogen, Botania Mana, and Ars Nouveau Source render with readable long amounts.",
