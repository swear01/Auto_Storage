...
SCENARIOS = {
    ...
    "crafting-fuel-page": {
        ...
        "checks": [
            ...
            "Cycle Search Sync through Off, Viewer, and Viewer Two-way. Off must leave the installed recipe viewer search untouched; Viewer must copy terminal text to EMI or JEI; Viewer Two-way must additionally copy viewer edits back into the terminal and refresh the storage results.",
    ...
    "flux-station": {
        ...
        "checks": [
            ...
            "Open the Flux conversion preview and confirm the animated Creating Flux diagram stays inside the same Craftable recipe-card bounds, keeps the shared ledger/navigation/craft controls, and shows exactly 1 redstone -> 1 flux dust.",
            "Confirm the animated diagram explains both bedrock and flux_block base options, with the station available from the world block and no world block/entity mutation during the storage transaction.",
