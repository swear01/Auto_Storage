...
`mods.railcraft.world.module.*`). The source-level top-level and nested type
components still reject Java reserved identifiers because generated Java emits
those components as class literals. Generated Auto Storage identifiers also
